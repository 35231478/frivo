...
interface WhatsAppInputProps extends InputHTMLAttributes<HTMLInputElement> {
  error?: boolean;
}
      ...
      <div className="relative">
        ...
        {tel.length >= 10 && (
          <a
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded text-gray-400 hover:text-green-600 transition-colors"
