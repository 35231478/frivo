...
export const metadata = { title: "Imprimir Relatório", robots: { index: false, follow: false } };

export default async function ImprimirRelatorioPage({ params }: { params: Promise<{ token: string }> }) {
